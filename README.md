...
> projext also has _"zero configuration"_ support so you can start coding right away. Read more about this on the [Zero Configuration document](./documents/zeroConfiguration.md).
...
[Read more about projext Zero Configuration](./documents/zeroConfiguration.md)
...
[Read more about the project configuration](./documents/projectConfiguration.md).
